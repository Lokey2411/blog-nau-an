		...
		<div className="bg-gray-100">
			...
			<div className="w-3/4 flex justify-center m-auto my-10">
				...
				<div className="flex-1 flex flex-col justify-between ml-6 h-auto">
					...
					<p>Tôi là Nguyễn Vũ Nhật Minh, một người Hà Nội. Tôi là một người có đam mê sâu sắc về nấu ăn và ẩm thực. Cái tên "Garan Food Blog" chỉ đơn giản là tên con chó nhà tôi (Gà rán) chứ không phải blog chỉ chia sẻ cách nấu gà rán đâu nhá!</p>
