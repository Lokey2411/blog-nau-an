...
export default function Contact() {
	return (
		<div className="bg-gray-100">
			...
			<Slogan />
			<div className="flex flex-col flex-1 justify-between w-1/3 m-auto">
				<UnderlineText>
				...
				<div className="w-full flex flex-col bg-white p-2">
					...
					/>
					<textarea
						className="flex-1 border-b border-b-black p-2 pb-28"
						placeholder="Type your message here"
					/>
					<button className="flex-1 bg-gray-300 py-2 my-2">Submit</button>
					<center className="flex-1 py-2 my-2">Thanks for submitting!</center>
				</div>
			</div>
			<Footer />
		</div>
